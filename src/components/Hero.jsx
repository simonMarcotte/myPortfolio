...
const Hero = () => {
  ...
  return (
    ...
    <section className="min-h-screen flex flex-col justify-start items-center p-5 text-center">
        ...
        <p className="max-w-xl font-light text-gray-400"> "I am a dedicated third-year Computer Engineering student at the University of Alberta with a passion for technology and problem-solving. I excel in programming and hardware, project management, and in collaborative environments. I am eager to continuously learn and contribute my skills to help improve our society."</p>
        ...
        <div>
            ...
            <a href={resumepdf} 
                target='_blank' 
                rel="noopener noreferrer"
                className="cursor-pointer flex z-50 items-center justify-center mt-10 dark:bg-zinc-900 bg-white text-zinc-900 dark:text-white outline py-2 rounded-lg font-bold hover:bg-zinc-300 dark:hover:bg-zinc-600 duration-500"
            > Resume
            </a>
